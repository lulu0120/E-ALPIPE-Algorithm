...
update_functions_id = function(y_1, y_2, N, T_2, num_points,prev_MLE=c(1,35,0.1,1),prev_opt = NULL,
  ...
  disagreement_weighted = determinant/(BG_var*SC_var)
  
  idx_max = which.max(disagreement_weighted)       # 与 order()[1] 等价
  selected_T2 = unique_T2[idx_max]
  cat("we select", selected_T2)
  #selected_T2 = which.max(total_variance_sum)
...
trials = function(num_trials, iterations, time_end,noise_1=noise_BG, noise_2=noise_SC){
  ...
  save(milly, file = "Benchmark30,withscales_stop20!.RData")
